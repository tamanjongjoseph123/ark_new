...
import videoNavigation from './utils/videoNavigation'
...
export default function Deliverance() {
  ...
  const handleVideoPress = videoNavigation(router);
  ...
  const fetchVideos = async () => {
    try {
      const response = await fetch(`${BASE_URL}/api/videos/by_category/?category=crusades`);
      if (!response.ok) {
